...
RUN set -x \
  ...
  && cd /tmp \
  && curl -L -o nomad_${NOMAD_VERSION}_linux_amd64.zip https://cdn.aws.robloxlabs.com/nomad/0.9.7/nomad-enterprise_0.9.7%2bent_linux_amd64.zip\
  && curl -L -o nomad_${NOMAD_VERSION}_SHA256SUMS      https://cdn.aws.robloxlabs.com/nomad/0.9.7/nomad-enterprise_0.9.7%2bent_linux_amd64.zip\
  && curl -L -o nomad_${NOMAD_VERSION}_SHA256SUMS.sig  https://cdn.aws.robloxlabs.com/nomad/0.9.7/nomad-enterprise_0.9.7%2bent_linux_amd64.zip\
  && export GNUPGHOME="$(mktemp -d)" \
